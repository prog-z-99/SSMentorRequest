import { Title, Text, Button, Container, Space, Checkbox } from "@mantine/core";
    ...
    <Container>
      <Text size="sm">
        ...
        <div className="terms">
          ...
          <p>Our mentors are here to help those who are serious about improving their gameplay and do that primarily through VOD reviews. The aim of mentoring is to provide you, the student, with general directions and learning objectives. If you meet the minimum requirements for a VOD review, a mentor will be reaching out to you through DMs. Please remember this is a free, volunteer-based service and wait times may vary depending on your rank, position, timezone, and mentor availability.
          </p>
          <p>
            If you are new or do
            not meet the requirements below but are still looking for a vod review, please use the #vod-review channel for a community review (check the pins for how to get started). Any other gameplay questions can be posted in any of the educational channels.
          </p>
          <Title size="h4">Minimum Requirements:</Title>
          <ul>
            <li>It has been 30 days since your last fulfilled mentor request</li>
            <li>
              You have <Text span fs="italic">at least</Text> 75 total ranked solo/duo queue games played during this current split
            </li>
            <li>
              You have <Text span fs="italic">at least</Text> 25 ranked games played on the champion in the
              VOD you submit
            </li>
          </ul>
          <Space h="lg" />
          ...
          <p>
            <Text>
              <Text span td="underline" fs="italic">Note</Text>:
              Mentors may deny a review request if you do not meet the
              minimum requirements. Exceptions can be made for very active players at the start of the split.
            </Text>
          </p>
