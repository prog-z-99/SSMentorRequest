    ...
    <Container>
      <div className="terms">
        ...
        <p>
          ...
          please read the following carefully on how to qualify for a VOD
          review.
        </p>
        ...
        <ul>
          ...
          <li>
            You must have a minimum of 25 ranked games on the champion in the
            VOD you submit
          </li>
          <li>
        ...
        <p>
          ...
          the start of the split. You may only request a VOD review once every
          30 days from your last fulfilled request.
        </p>
        <p>
          This is a free, volunteer-based service. Wait times may be longer
          depending on your rank, position, or timezone. If you are new or do
          not meet the requirements above, you can ask questions in any of our
          Discord’s role-specific chats or use #vod-review for a community
          review (check the pins for details).
        </p>
