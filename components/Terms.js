...
export default function Terms({ setTerms }) {
  ...
  return (
    <Text size="sm">
      ...
      <p>
        Our mentors are here to help those who are serious about improving their
        gameplay and do that primarily through VOD reviews. The aim of mentoring
        is to provide you, the student, with general directions and learning
        objectives. If you meet the minimum requirements for a VOD review, a
        mentor will be reaching out to you through DMs. Please remember this is
        a free, volunteer-based service and wait times may vary depending on
        your rank, position, timezone, and mentor availability.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          75 total ranked solo/duo queue games played during this current split
        </li>
        <li>
          You have{" "}
          <Text span fs="italic">
      ...
      <Text>
        ...
        briefly to understand what went wrong or well. Identify major weaknesses
        and areas for improvement. Focus on overarching habits and general
        gameplay, not specific details. Ask yourself things like &#34;Do I keep
        dying to jungler ganks?&#34; or &#34;Do my waves somehow end up in bad
        positions?&#34; Come up with some questions to ask your mentor so you
